		...
		'<div class="sidebar-settings preview-toggle">' +
			'<div class="sidebar-content sticky-sidebar-one">' +
				'<div class="sidebar-header">' +
					...
					'<a class="sidebar-close" href="#"><img src="assets/img/icons/siderbar-icon2.svg" alt=""></a>' +
				'</div>' +
				'<div class="sidebar-body">' +
					'<h6 class="theme-title">Choose Mode</h6>' +
					'<div class="switch-wrapper">' +
						'<div id="dark-mode-toggle">' +
							'<span class="light-mode active"> <img src="assets/img/icons/siderbar-icon2.svg" class="me-2" alt=""> Light</span>' +
						...
						'<div class="col-xl-6 ere">' +
							'<div class="layout-wrap">' +								
								...
								'<div class="layout-img">' +
									'<img class="img-fliud" src="assets/img/avatar-02.jpg" alt="layout">' +
								'</div>' +
							'</div>' +
						'</div>' +
						'<div class="col-xl-6 ere">' +
			...
			'<div class="sidebar-content sticky-sidebar-one">' +
				'<div class="sidebar-header">' +
					'<h5>Navigation Settings</h5>' +
				 	'<a class="sidebar-close" href="#"><img src="assets/img/icons/avatar-02.jpg" alt=""></a>' +
				'</div>' +
			 	'<div class="sidebar-body">' +
